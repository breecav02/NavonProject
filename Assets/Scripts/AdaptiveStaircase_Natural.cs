...
public class AdaptiveStaircaseNatural : MonoBehaviour
{
    /// <summary>
    /// This script initialises and handles the update of staircase values based on participant responses.
    /// NOW CONFIGURED FOR LETTER SPACING + RADIAL ECCENTRICITY
    /// Lower intensity = tighter spacing + center = EASIER
    /// Higher intensity = wider spacing + periphery = HARDER
    /// GRADUAL VERSION: Smaller step sizes for smoother adaptation
    /// </summary>
    ...
    public void InitializeStaircase()
    {
        ...
        Debug.Log($"GRADUAL Natural Staircase initialized: Type={staircaseType}, Initial={initialIntensity:F3}, StepSize={initialStepSize:F3} (gradual)");
    }
    ...
    {
        Debug.Log("=== GRADUAL NATURAL STAIRCASE SUMMARY ===");
